...
public class TProductController {
    ...
    public R list(@RequestParam Map<String, Object> params) {
        ...
        PageUtils pageUtil = new PageUtils(tProductList, total, query.getLimit(), query.getPage());
    ...
    public R queryImages(@RequestParam Map<String, Object> params) {
        ...
        List<TImageEntity> list = tProductService.queryImages(Long.parseLong(id.toString()));
        return R.ok().put("list", list);
    }
