 ...
 * @returns {*}
 */
function transPhoto(url,wechat_no,wechat_name) {
    if (url) {
    	var imgUrl = '<img width="50px" height="50px" src="' + url + '">';
    	var result = "<div>"+imgUrl+"<span>"+wechat_name+"</span><span>"+wechat_no+"</span></div>";
        return result;
    } else {
        return '-';
    }
