...
let vm = new Vue({
	...
	methods: {
		...
		exportClient: function () {
            exportFile('#rrapp', '../tclient/export', {'name': vm.q.name,'mobile': vm.q.mobile,'clientType': vm.q.clientType});
        },
		reload: function (event) {
			vm.showList = true;
            let page = $("#jqGrid").jqGrid('getGridParam', 'page');
			$("#jqGrid").jqGrid('setGridParam', {
                postData: {'name': vm.q.name,'clientType': vm.q.clientType,'mobile': vm.q.mobile},
                page: page
            }).trigger("reloadGrid");
